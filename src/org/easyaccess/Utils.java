...
public class Utils {
	/**
	 * Consists of constants and static methods that would be used by various
	 * classes the constitute easyaccess.
	 **/
	...
	/**
	 * Applies a background color and text color to the buttons, text views and
	 * radio buttons in the view passed as a parameter.
	 * 
	 * @param view
	 *            The view whose child elements should be determined.
	 * @param bgColor
	...
	/**
	 * Applies a text size to the buttons, text views and radio buttons in the
	 * view passed as a parameter.
	 * 
	 * @param view
	 *            The view whose child elements should be determined.
	 * @param fontSize
	 *            The text size to be applied.
	 */
	...
	/**
	 * Applies a font type to the buttons, text views and radio buttons in the
	 * view passed as a parameter.
	 * 
	 * @param view
	 *            The view whose child elements should be determined.
	...
	/**
	 * Retrieves the saved background and text colors and applies to the views
	 * in the layout.
	 * 
	 * @param context
	 *            The context of the application that invokes the method.
	 * @param layout
	 *            The layout in which the color changes are to be applied.
	 */
	public static void applyFontColorChanges(Context context,
			LinearLayout layout) {
	 ...
	 *            The context of the application that invokes the method.
	 * @param layout
	 *            The layout in which the text size changes are to be applied.
	 */
	 ...
	 *            The context of the application that invokes the method.
	 * @param layout
	 *            The layout in which the font type changes are to be applied.
	 */
	public static void applyFontTypeChanges(Context context, LinearLayout layout) {
		...
		if (preferences.getInt("typeface", -1) != -1) {
			Utils.iterateToApplyFontType(layout,
	 ...
	 * 
	 * @param context
	 *            The context of the application that invoked the method.
	 * @return Returns true if an accessibility service is enabled, else,
	 *         returns false.
	 */
	 ...
	 *            The context of the application that invoked the method.
	 * @param button
	 *            The button with which the onFocusChange listener is to be
	 *            associated.
	 */
