...
public class Utils {
	...
	**/
	...
	/**
	* Applies a background color and text color to the buttons, text views and radio buttons in the 
	...
	*/
	...
	public static void iterateToApplyColor(View view, int bgColor, int fgColor) {
		if(view instanceof ViewGroup) {
			...
			if(view.getClass() == Button.class && view.getId() != R.id.btnNavigationBack && 
					...
					if(bgColor != view.getContext().getResources().getColor(R.color.card_background_regular)) {
						...
						((Button)view).setBackgroundDrawable(((Button)view).getContext().
	...
	/**
	* Applies a text size to the buttons, text views and radio buttons in the view 
	...
	*/
	public static void iterateToApplyFontSize(View view, float fontSize) {
		if(view instanceof ViewGroup) {
			...
			if(view.getClass() == Button.class && view.getId() != R.id.btnNavigationBack && view.getId() !=
					R.id.btnNavigationHome) {
	...
	/**
	* Applies a font type to the buttons, text views and radio buttons in the view 
	* passed as a parameter.
	* @param view The view whose child elements should be determined.
	...
	*/
	public static void applyFontColorChanges(Context context, LinearLayout layout) {
		//get the values in SharedPreferences
				SharedPreferences preferences = context.getSharedPreferences(context.getResources().
				...
				if(preferences.getInt("bgcolor", -1) != -1 || preferences.getInt("fgcolor", -1) != -1) {
					...
					Utils.iterateToApplyColor(layout, context.getResources().
							getColor(R.color.card_background_regular), context.getResources().
	...
	*/
	public static void applyFontSizeChanges(Context context, LinearLayout layout) {
				...
				if(preferences.getFloat("size", 0) != 0) {
					...
					Utils.iterateToApplyFontSize(layout, Integer.valueOf(context.getResources().
							getString(R.string.defaultFontSize)));// * context.getResources().
