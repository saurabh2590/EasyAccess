...
public class SettingsVolume extends EasyAccessActivity {
	/**
	 * The Volume option in easyaccess Settings lists the options for various
	 * levels of volume. The options are Softest, Softer, Soft, Normal, Louder,
	 * Loudest.
	 */
	...
	/**
	 * Attaches onCheckedChange listener to the RadioGroup displaying all the
	 * volume levels. Based on the radio button selected, the media volume of
	 * the phone is set accordingly and a TTS feedback is given to the user,
		...
		rgVolume.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup rg, int radioButtonId) {
				...
				case R.id.radioSoftest:
					Utils.audioManager.setStreamVolume(
							AudioManager.STREAM_MUSIC, 3,
							AudioManager.FLAG_PLAY_SOUND);
					TTS.speak(((RadioButton) findViewById(radioButtonId))
							.getText().toString());
					break;
