...
public class ScreenCurtainFunctions extends Application {
	 ...
	 * 
	 * @param inflater
	 *            The instance of LayoutInflater using which layout parameters
	 *            are applied to the view.
	 * @return the instance of LayoutParamsAndViewUtils that can be used to
	 *         implement screen curtain.
	 */
	public static LayoutParamsAndViewUtils prepareForCurtainCheck(
		...
		LayoutParamsAndViewUtils layoutParamsAndView = new LayoutParamsAndViewUtils(
				layoutParams, view);
