...
public class SettingsMenu extends EasyAccessActivity {
	/**
	 * The Settings menu in easyaccess displays all the options for modifying
	 * the settings of easyaccess.
	 */

	/** Declare all the Buttons used in the activity **/
	private Button btnSettingsScreenCurtain, btnSettingsColor, btnSettingsFont,
	btnSettingsVolume, btnSettingsAndroid, btnAbout,btnSettingsVoiceTTS;
private int screenCurtainFlag;

/**
* Enables or disables the screen curtain system-wide depending on current
* state.
**/
...
/** Launches the Voice and Text to Speech Settings menu. **/
void startSettingsVoiceTTS() {
Intent intent = new Intent(getApplicationContext(), SettingsVoiceTTS.class);
startActivity(intent);
}	
...
btnSettingsVoiceTTS = (Button) findViewById(R.id.btnSettingsVoiceTTS);
...
attachListener(btnSettingsVoiceTTS);
